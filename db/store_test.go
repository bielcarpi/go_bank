...
func TestTransferTx(t *testing.T) {
	...
	// Run n concurrent transfer transactions to make sure that the balance is always consistent
	n := 5
	amount := int64(10)
	...
	for i := 0; i < n; i++ {
		...
		// Check if the transfer entries are created successfully
		...
		// TODO: Check the accounts balance
	}
}
